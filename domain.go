...
type Obfuscation struct {
	...
	H1   int // initiator to Responder (1, 1<<32-1)
	H2   int // Responder to initiator (1, 1<<32-1)
	H3   int // Data Packet (1, 1<<32-1)
	H4   int // Cookie Reply (1, 1<<32-1)
}
...
func (p *Peer) Info() {
	...
	fmt.Println("Private Key:", p.PrivateKey)
